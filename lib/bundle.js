	  ...
	  _createClass(Game, [{
	    ...
	    value: function isGameOver() {
	      ...
	      if (this.astronaut.y >= 550) {
	        ...
	        if (document.cookie === "") {
	          ...
	          var prevHighScore = parseInt(document.cookie);
	    ...
	    value: function renderAsteroids() {
	      ...
	      this.asteroids.forEach(function (asteroid) {
	        _this4.stage.addChild(asteroid);
	        _this4.stage.update();
	      });
	    }
	  }, {
	    ...
	    value: function shiftAsteroids() {
	      ...
	      this.asteroids.forEach(function (asteroid) {
	        var acc = -0.15;
	        var vel = 6;
	        var intervalMove = setInterval(move.bind(_this5), 10);
	        var intervalDec = setInterval(decellerate.bind(_this5), 10);
	    ...
	    value: function cleanUpAsteroids() {
	      ...
	      this.asteroids.forEach(function (asteroid) {
	        if (asteroid.y >= 600) {
	          _this6.removeAsteroid(asteroid);
	          _this6.addAsteroid();
	        }
	      });
	    }
